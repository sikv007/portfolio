...
export default function Home() {
  return (
    <main className='bg-neutral-900 w-screen h-screen overflow-hidden'>
      <Logo />
      <Container className='flex flex-col gap-4 mt-16 relative z-10'>
        <section className='text-white text-center flex flex-col gap-2 items-center'>
          <Avatar />
          <h1 className='font-extrabold text-3xl md:text-4xl'>Sigurd Illguth Kvamme</h1>
          <p>Fullstack Developer</p>
          <hr className='opacity-10' />
        </section>
        <section className='flex gap-4 items-center justify-center'>
          <ExternalLink href='https://github.com/sikv007'>
            <svg viewBox='0 0 128 128' className='w-6'>
              <g fill='currentColor'>
                <path
                  fill-rule='evenodd'
                  clip-rule='evenodd'
          ...
          <ExternalLink mode='secondary' href='https://www.linkedin.com/in/sigurd-illguth-kvamme-3ab08b225/'>
            <svg viewBox='0 0 128 128' className='w-6'>
              <path
                fill='currentColor'
                d='M116 3H12a8.91 8.91 0 00-9 8.8v104.42a8.91 8.91 0 009 8.78h104a8.93 8.93 0 009-8.81V11.77A8.93 8.93 0 00116 3z'></path>
              <path
                className='fill-black group-hover:fill-purple-500'
